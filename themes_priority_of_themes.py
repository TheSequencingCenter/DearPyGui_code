...
with dpg.window(label="Tutorial win1", pos=(20, 50), width=275, height=225) as win1:
    t1 = dpg.add_input_text(default_value="some text t1")
    t2 = dpg.add_input_text(default_value="some text t2")
    with dpg.child_window(height=100):
        t3 = dpg.add_input_text(default_value="some text t3")
        dpg.add_input_int()
    dpg.add_input_text(default_value="some text t4")

with dpg.window(label="Tutorial win2", pos=(320, 50), width=275, height=225) as win2:
    dpg.add_input_text(default_value="some text t1")
    dpg.add_input_int()
