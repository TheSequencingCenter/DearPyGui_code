...
with dpg.window(label="Main window", width=1000, height=562, show=True, tag="main_window"): # 16:9 ratio
    ...
    # dpg.add_text(default_value="add_text 1", tag="add_text")
    dpg.add_input_text(default_value="add_input_text 1", width=300)
    dpg.add_text(default_value="add_text 1")
    dpg.add_input_text(default_value="add_input_text 2", width=300)
    dpg.add_text(default_value="add_text 2")
